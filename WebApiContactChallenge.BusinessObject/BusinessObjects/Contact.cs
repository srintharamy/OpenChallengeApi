...
namespace WebApiContactChallenge.BusinessObject.BusinessObjects
{
    ...
    /// </summary>
    public class Contact : BusinessObjectBaseKey, IContact
    {
        ...
        [Required] [MaxLength(10)] public string PoBox { get; set; }
        [Required] [MaxLength(20)] public string Country { get; set; }
        [Required] [MaxLength(20)] [Phone] public string MobilePhoneNumber { get; set; }

        public IEnumerable<IContactSkill> MySkills { get; set; }
    }
}